                ...
                else if (doorChoice == "OPEN")
                {
                    ...
                    switch (keyChoice)
                    {
                        ...
                        case "3":
                            ...
                            break;
                        default:
                            Console.WriteLine("In your inability to choose between three keys, " +
                                "you fumble with the key ring and are left watching as the keys " +
                                "fall and slip through the cracks on the floor board. " +
                                "You really need to get that floor fixed!");
